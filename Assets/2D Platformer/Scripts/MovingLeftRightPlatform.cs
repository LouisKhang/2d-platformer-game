...
public class MovingLeftRightPlatform : MonoBehaviour // Đổi tên class cho phù hợp
{
    [Header("Movement Settings")]
    public float speed = 1.5f;
    public float horizontalDistance = 4f; // Khoảng cách tổng cộng di chuyển (Trái/Phải)
    ...
    void Start()
    {
        ...
        // 2. Tính toán vị trí đích (Di chuyển theo TRỤC X)
        // Thay vì dùng new Vector3(0, distance, 0) cho trục Y,
        // ta dùng new Vector3(horizontalDistance, 0, 0) cho trục X.
        endPosition = startPosition + new Vector3(horizontalDistance, 0, 0);
